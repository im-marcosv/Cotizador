...
const Formulario = ({guardarResumen, guardarCargando}) => {
    ...
    const cotizarSeguro = e => {
        ...
        //Obtener diferencia de años -- Por cada año 3%
        const diferencia = obtenerDiferenciaYear(year);
        resultado -= ((diferencia * 3) * resultado) / 100;
        
        //Incremento por marca: Americano 15%, Asiatico 5%, Europeo 30%
        resultado = obtenerMarca(marca) * resultado;
        //Plan basico aumenta 20%, Plan Completo 50%
        const incPlan = obtenerPlan(plan);
    ...
    return ( 
        <form onSubmit={cotizarSeguro}>
            ...
            <Campo>
                <Label>Plan</Label>
                <Radio type="radio" name="plan" value="basico" checked={plan === "basico"} onChange={obtenerInfo}/> Básico
                <Radio type="radio" name="plan" value="completo" checked={plan === "completo"} onChange={obtenerInfo}/> Completo
            </Campo>
